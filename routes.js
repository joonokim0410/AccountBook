...
router.post('/spreadsheets', function(req, res, next) {
  ...
  // var title = 'Account Book (' + new Date().toLocaleTimeString() + ')';
  var title = 'Account Book';
...
router.post('/spreadsheets/:id/del', function(req, res, next) {
 models.Spreadsheet.findById(req.params.id)
     .then(function(Spreadsheet){
       if(!Spreadsheet){
         throw new Error('Spreadsheet not found' + req.params.id);
       }
